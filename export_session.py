...
async def main():
    ...
    print("⚠️  Make sure to STOP the bot on Render first to release the session!\n")
    ...
    try:
        ...
        if not await client.is_user_authorized():
            ...
            print("💡 You need to authorize first with: python -m telethon_session")
        ...
        print("\n" + "="*70)
        print("✅ SESSION STRING (add this to Render environment variables):")
        print("="*70)
