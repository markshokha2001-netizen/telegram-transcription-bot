...
async def handle_link(message: Message):
    ...
    await message.answer(
        ...
        "**Как получить транскрипцию YouTube:**\n\n"
        "1️⃣ Отправьте вашу ссылку боту @VideoDownloadBot\n"
        "2️⃣ Скачайте mp3 файл\n"
        "3️⃣ Отправьте файл мне\n"
        "4️⃣ Я сделаю транскрипцию + AI-исправление + конспект + экспорт\n\n"
        "**Или:**\n"
